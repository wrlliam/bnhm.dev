            ...
            <AnimatePresence>
              {isOpen && (
                ...
                >
                  <a
                    href={url}
                    className="block p-1 bg-accent-main/20 border-2 smooth_transition border-transparent shadow rounded-xl hover:border-neutral-200/20 dark:hover:border-neutral-800"
                    style={{ fontSize: 0 }}
                  >
                    <img
